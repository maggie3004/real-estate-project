...
const SaiShraddhaApartment = () => {
  const projectData = {
    ...
    images: [
      "/assets/sai-shraddha-apartment/gallery/1.jpg",
      "/assets/sai-shraddha-apartment/gallery/2.jpg",
      "/assets/sai-shraddha-apartment/gallery/3.jpg",
      "/assets/sai-shraddha-apartment/gallery/4.jpg",
      "/assets/sai-shraddha-apartment/gallery/5.jpg"
    ],
    brochurePath: "/assets/sai-shraddha-apartment/brochures/Sai-Shraddha-Apartment.pdf",
