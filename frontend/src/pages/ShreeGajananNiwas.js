...
const images = [
  '/shree-gajanan-niwas/image1.jpg',
  '/shree-gajanan-niwas/image2.jpg',
  '/shree-gajanan-niwas/image3.jpg',
  '/shree-gajanan-niwas/image4.jpg',
  '/shree-gajanan-niwas/image5.jpg',
  '/shree-gajanan-niwas/image6.jpg',
  '/shree-gajanan-niwas/image7.jpg'
];

const ShreeGajananNiwas = () => {
  const [isGalleryOpen, setGalleryOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const [isPlaying, setIsPlaying] = useState(true);
  const projectName = 'Shree Gajanan Niwas';
  const tagline = 'Modern Living in Traditional Style';
          ...
          <div className="grid">
            <div className="max-w-4xl mx-auto px-4">
              <div className="text-gray-200 text-base md:text-lg leading-relaxed text-justify">
                Shree Gajanan Niwas represents the perfect blend of traditional values and modern amenities. This residential project offers spacious apartments designed to provide comfort and convenience to its residents. With quality construction and thoughtful planning, each home is crafted to meet the highest standards of modern living while maintaining a connection to traditional architectural elements.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-gray-900 rounded-lg p-4 text-center transform hover:scale-105 transition-transform duration-300">
              <div className="text-xl md:text-2xl font-bold text-gold mb-1">Traditional</div>
            ...
            <div className="bg-gray-900 rounded-lg p-4 text-center transform hover:scale-105 transition-transform duration-300">
              ...
              <div className="text-lg md:text-xl text-gray-200">Construction</div>
            </div>
            <div className="bg-gray-900 rounded-lg p-4 text-center transform hover:scale-105 transition-transform duration-300">
              <div className="text-xl md:text-2xl font-bold text-gold mb-1">Spacious</div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="aspect-video w-full rounded-xl overflow-hidden shadow-lg">
              <iframe
                ...
                title="Shree Gajanan Niwas Location"
                className="w-full h-full"
              ></iframe>
            </div>
            <div className="mt-4 text-center">
              <a
                href="https://www.google.com/maps/dir//Shree+Gajanan+Niwas+Nashik"
                target="_blank"
...
export default ShreeGajananNiwas;
