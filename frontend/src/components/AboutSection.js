  ...
  <section className="py-12 md:py-20 bg-white dark:bg-black/50 transition-colors duration-300">
    <div className="max-w-4xl mx-auto px-4 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        {/* Mission Box */}
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800/20 dark:to-gray-700/20 p-8 rounded-2xl text-left border border-gray-200 dark:border-gray-700/30 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3 mb-4">
            <FaHeart className="text-gray-600 dark:text-gray-400 text-2xl" />
            <h3 className="text-2xl font-bold text-gray-700 dark:text-gray-200">Our Mission</h3>
          </div>
        ...
        {/* Vision Box */}
        <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-8 rounded-2xl text-left border border-green-200 dark:border-green-700/30 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3 mb-4">
